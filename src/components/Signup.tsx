  ...
  return (
    <div className='container mx-auto flex w-full flex-cols justify-center items-center space-y-6 sm:w-[400]'>
        <div className='flex flex-col space-y-2 text-center'>
            ...
            />
            <h1 className='text-2xl font-semibold tracking-light'>New to Bredit</h1>
            ...
            <p className='text-center px-8 text-sm text-zinc-600'>
              ...
              Already a user? {' '}
              <Link href='/sign-in' className='hover:text-zinc-900 text-sm underline underline-offset-4'>Sign in</Link>
            </p>
        </div>
        </div>
  )
